...
namespace ST
{
    public partial class falban : Form
    {
        public falban()
        {
            InitializeComponent();
      ...
      //  MySqlConnection con = new MySqlConnection(Properties.Settings.Default.selbeg2ConnectionString);
        ...
        {
           MessageBox.Show(Convert.ToString(gridView1.TopRowIndex));
        }
        ...
        private void labelload_EditValueChanged(object sender, EventArgs e)
        {
