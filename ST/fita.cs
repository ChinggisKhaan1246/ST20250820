...
namespace ST
{
    public partial class fita : Form
    {
        Form1 f;
        public fita(Form1 ff)
        {
            InitializeComponent();
            f = ff;
        ...
        private void gridControl5_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                ...
                Process.Start("chrome.exe", "https://selbeg.shop/devsoft/dist/uploads/ita/docu/" + encode + "");
        ...
        private void засахToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (xtraTabControl1.SelectedTabPageIndex == 0)
                {
                    eita.itaID.Text = gridView5.GetFocusedRowCellValue("id").ToString();
